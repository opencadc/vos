...
public class ServiceAvailability implements AvailabilityPlugin {
    ...
    private static String DATA_AVAIL = "ivo://cadc.nrc.ca/data";
...
//TODO
//            CheckResource[] checkResources = VOSpaceNodePersistence.getAvailabilityCheck();
//            for (CheckResource cr : checkResources) {
//                cr.check();
//            }
//
//            checkResources = VOSpaceSybaseJobPersistence.getAvailabilityCheck();
//            for (CheckResource cr : checkResources) {
//                cr.check();
//            }
            ...
            url = reg.getServiceURL(URI.create(DATA_AVAIL), Standards.VOSI_AVAILABILITY, AuthMethod.ANON);
            checkResource = new CheckWebService(url);
            checkResource.check();
    ...
    public void setState(String state) {
        ...
        log.info("WebService state changed to " + state);
    }
