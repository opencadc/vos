...
//            syncTransferURL = new URL(baseURL + "/synctrans");
            ...
            URI serviceURI = nodeURI.getServiceURI();
            URL nodesURL = rc.getServiceURL(serviceURI, Standards.VOSPACE_NODES_20, AuthMethod.CERT);
            ...
            anonNodeResourceURL = new URL(nodeResourceURL.toExternalForm().replace("https","http"));
            anonAsyncTransferURL = new URL(asyncTransferURL.toExternalForm().replace("https","http"));
            anonSyncTransferURL = new URL(syncTransferURL.toExternalForm().replace("https","http"));
    ...
    public void testAnonAccessNode()
    {
        try
        {
            ...
            HttpDownload get = new HttpDownload(anonNodeResourceURL, bos);
            get.run();
    ...
    private static void putNode(URL url, Node node) throws Exception
    {
