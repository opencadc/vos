 ...
 * @author jeevesh
 */
public class PackageJobManager extends JobManager {
    private static final Logger log = Logger.getLogger(PackageJobManager.class);

    private static final Long MAX_EXEC_DURATION = 2000L; // proxied download
    private static final Long MAX_DESTRUCTION = 20000L;
    private static final Long MAX_QUOTE = 20000L;
    ...
    public PackageJobManager() {
        ...
        // Same values as used by SyncTransferManager
