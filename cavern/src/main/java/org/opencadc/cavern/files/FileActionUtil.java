...
public class FileActionUtil {
    private static final Logger log = Logger.getLogger(FileActionUtil.class);
    protected static final String PREAUTH_INIT_PARAM = "isPreAuthRequest";

    public FileActionUtil() {}

    public static VOSURI initPreauthTarget(String path, Map<String, String> initParams, Direction direction) throws AccessControlException, IOException, URISyntaxException {
        VOSURI nodeURI = null;
    ...
    public static VOSURI initFilesTarget(String path, Map<String, String> initParams, Direction direction) throws AccessControlException, IOException, URISyntaxException {
        // TODO: placeholder exception
        throw new UnsupportedOperationException("direct access to files endpoint not fully implemented yet.");

        //        VOSURI nodeURI = null;
        // TODO: this will be where a potentially different function from getNodeURI
