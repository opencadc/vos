...
/**
 * Prototype plugin to get and set storage quota on a container node. This plugin
 * only makes sense when quotas are a property of container nodes aka directories
 * and is not intended to be a general purpose quota plugin mechanism.
 * 
 * @author pdowler
 */
public interface QuotaPlugin {
    ...
    /**
     * Set or clear the byte quota on a directory.
     * 
